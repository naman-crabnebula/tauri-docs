...
Notification channels are a way to group and manage notifications in Android applications. By default, all the notifications are sent to `Default` channel. To create and send notification in a custom channel:
